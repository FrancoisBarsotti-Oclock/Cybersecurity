...
## Conteneurisation d’applicatifs
Une application, ou applicatif, est un logiciel décrit sous forme de code [exécutable](https://fr.wikipedia.org/wiki/Fichier_ex%C3%A9cutable) qui sera interprété par un runtime (environnement d’exécution).
...
[Fiche-récap Docker](https://github.com/FrancoisBarsotti-Oclock/Cybersecurity/blob/main/Portfolio/Supports%20Divers/Conteneurs%20%26%20Docker/Fiche%20Docker.md)
