# 🏆 Challenge C105: QCM 10, Gestion de projet
### François BARSOTTI
## 🎯 Pitch et Contexte du challenge

Cette session a consisté à l'application d'un QCM sur la saison C1 (Gestion de projet), la discussion des doutes, la présentation du bilan de la saison et la présentation sommaire de ce qui sera traité à la saison suivante (C2).
...
Pour la saison C2, on est invité à suivre la route en passant par 👉 [Challenge_C201] 👈
